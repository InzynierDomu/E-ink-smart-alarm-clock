...
void ui_Screen1_screen_init(void)
{
    ...
    lv_label_set_text(ui_labWeatherIcon, "A");
    ...
    lv_label_set_text(ui_labWeatherIconDay1, "D");
    ...
    lv_label_set_text(ui_labWeatherIconDay2, "C");
    ...
    lv_label_set_text(ui_labWeatherIconDay3, "B");
